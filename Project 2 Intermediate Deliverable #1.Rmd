...
```
The accuracy for the improved SVM model is (94 + 27) / (94 + 27 +22+11) = 78.57%. The false positive rate is 10.45% and the false negative rate is 44.88%. This represents a worse performance than the initial SVM model because accuracy went down and the false negative rate increased. Moving forward, we would plan to stick with the vanilladot kernel instead of rbfdot in models we build that also use the existing SVM.
